...
public class CustomCalendarView extends LinearLayout {
    ...
    private int daysShownTextColor;
    private int currentMonthIndex = 0;
    private boolean isOverflowDateVisible = false;
    ...
    private void getAttributes(AttributeSet attrs) {
        ...
        daysShownTextColor = typedArray.getColor(R.styleable.CustomCalendarView_daysShownTextColor, getResources().getColor(R.color.black));
        typedArray.recycle();
    }
    ...
    private void initializeWeekLayout() {
        ...
        for (int i = 1; i < weekDaysArray.length; i++) {
            ...
            dayOfWeek.setTextColor(daysShownTextColor);
    ...
    public void markDayAsSelectedDay(Date currentDate) {
        ...
        //view.setTheColorForSelected(Color.parseColor(ColorCode.colorBlue));
        //view.setBackgroundColor(Color.parseColor(ColorCode.colorBlue));
        view.setColor(Color.parseColor(ColorCode.colorBlue));
