...
public class DayView extends TextView {
    ...
    private int id;
    int colorToDraw = Color.parseColor(ColorCode.colorBlue);
  ...
  /* public void getIds(int id)
   {
    ...
    /**
     * It forces the drawable to draw the
     * shape as circular when selected
     */
   /* @Override
...
public void setColor(int color)
{
    ...
    circlePaint.setColor(colorToDraw);
...
public void drawForSelected()
{
 ...
 /* Paint strokePaint = new Paint();
    strokePaint.setColor(getResources().getColor(Color.parseColor(strokePaint)));
